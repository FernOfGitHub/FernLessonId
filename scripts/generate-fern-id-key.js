...
const fernDatabase = [
  ...
  { name: 'Hay-scented Fern', scientific: 'Dennstaedtia punctilobula', regions: ['northeast', 'atlantic'], habitat: ['forest', 'open'], frondType: 'bipinnatePinnatifid', frondTypeAlternates: ['thrice'], size: 'medium', texture: 'hairy' },
